Параметры для изменения шрифта "Список литературы" в word
Шрифт: Times New Roman, 14 пт, Отступ:
    Первая строка:  1,25 см, По ширине
    междустрочный,  1,5 строки, интервал
    после: 0 пт
    Поз.табуляции:  2,25 см, по левому краю, Стиль: Связанный, Скрыть до использования, Приоритет: 38
...
Желающие отблагодарить автора стилей ГОСТ могут сделать перевод через Сбербанк Онлайн на номер телеона +7-905-820-5283 (Распопов Роман Владимирович). Или любым другим способом.
